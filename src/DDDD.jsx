    ...
    <>
      <div className="orderpage">
        ...
        <div className="formDiv ">
          <div className="flexStart allPadding">
            {" "}
            ...
            <p className="flexStart allPadding">
          ...
          <div>
            <Form>
              <div
                className="displayRow allPadding spaceBetween
                           "
              >
                <div className="chooseSize">
                  <h2>
                    Boyut Seç<span className="colorRed">*</span>
                  </h2>
                  <FormGroup check>
                ...
                <div className="chooseSize">
                  <h2>
                    Hamur Seç<span className="colorRed">*</span>
                  </h2>
